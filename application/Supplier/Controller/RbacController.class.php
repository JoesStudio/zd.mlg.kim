...
class RbacController extends SupplierbaseController {
    ...
    public function authorize() {
        $this->auth_access_model = D("Common/BizAuthAccess");
       //角色ID
    ...
    public function authorize_post() {
        ...
        if (IS_POST) {
            ...
            if (is_array($_POST['menuid']) && count($_POST['menuid'])>0) {
                ...
                $menu_model=M("Menu");
                $auth_rule_model=M("BizOpauthRule");
                ...
                foreach ($_POST['menuid'] as $menuid) {
                    ...
                    if($menu){
                        ...
                        $this->auth_access_model->add(array("role_id"=>$roleid,"rule_name"=>$name,'type'=>'supplier_url'));
                    }
                }
