...
$configs= array(
        ...
        'MODULE_ALLOW_LIST'  => array('Fans','Sms','Aliyun','Bizauth','Collect','Address','Supplier','Customer',
            'Demand','Cart','Order','Tf','Colorcard','Notify','Admin','Portal','Asset','Api','User','Wx','Comment',
            'Qiushi','Tpl','Topic','Install','Bug','Better','Pay','Cas','Account','Distribution','Style'),
        ...
        'SP_TMPL_PATH'     		=> 'tpl/home/',       // 前台模板文件根目录
